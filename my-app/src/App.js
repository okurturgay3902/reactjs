...
import Clock3 from "./components/23-clock3";
        ...
        <Container fluid>
          <Row>
            ...
            <Routes>
              ...
              <Route path="/Clock/sari" element={<Clock2 color="red"  bgColor="yellow"/>}/>
              <Route path="/Clock/mavi" element={<Clock2 color="yellow"  bgColor="navy"/>}/>
              <Route path="/Clock/siyah" element={<Clock2 color="white"  bgColor="black"/>}/>
              ...
              <Route path="/Props/Metin" element={<Props ad="Metin" yas="33"/>}/>
              <Route path="/Props/Turgay" element={<Props ad="Turgay" yas="46"/>}/>
